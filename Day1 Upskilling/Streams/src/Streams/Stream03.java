...
public class Stream03 {
	    ...
	    public static List<String> traderFromPuneSortByName(List<Trader> traders){
	        List<String> list=new ArrayList<>();
	        traders.stream()
	    ...
	    public static void main(String[] args) {
	        ...
	        Trader t2=new Trader("bde", "Delhi");
	        Trader t3=new Trader("def", "Pune");
	        Trader t4=new Trader("fgh", "Lucknow");
	        Trader t5=new Trader("hij", "Varanasi");
	        Trader t6=new Trader("jkl", "Kolkata");
	        Trader t7=new Trader("lmn", "Pune");
	        Trader t8=new Trader("opq", "Indore");
	        ...
	        List<String> l1 = traderFromPuneSortByName(arr);
